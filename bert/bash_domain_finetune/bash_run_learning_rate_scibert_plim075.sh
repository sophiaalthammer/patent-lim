...
do
 DESTINATIONS+="./data/tfrecord_128_lim_075_sci_part-000000000${run}.tfrecord,"
done
DESTINATIONS=${DESTINATIONS::-1}
echo $DESTINATIONS
wait
export BERT_BASE_DIR=/home/ubuntu/bert
python run_pretraining.py --input_file=$DESTINATIONS  --output_dir=$BERT_BASE_DIR/output/scibert_lim_p075/pretrain2e05   --do_train=True   --do_eval=True   --bert_config_file=$BERT_BASE_DIR/bert_config.json   --init_checkpoint=$BERT_BASE_DIR/bert_model.ckpt   --save_checkpoints_steps=500   --train_batch_size=32   --max_seq_length=128   --max_predictions_per_seq=20   --num_train_steps=2500   --num_warmup_steps=250 --learning_rate=2e-5
wait
...
wait
python run_pretraining.py --input_file=$DESTINATIONS  --output_dir=$BERT_BASE_DIR/output/scibert_lim_p075/pretrain1e04   --do_train=True   --do_eval=True   --bert_config_file=$BERT_BASE_DIR/bert_config.json   --init_checkpoint=$BERT_BASE_DIR/bert_model.ckpt   --save_checkpoints_steps=500   --train_batch_size=32   --max_seq_length=128   --max_predictions_per_seq=20   --num_train_steps=2500   --num_warmup_steps=250 --learning_rate=1e-4
wait
...
wait
python run_pretraining.py --input_file=$DESTINATIONS  --output_dir=$BERT_BASE_DIR/output/scibert_lim_p075/pretrain5e05   --do_train=True   --do_eval=True   --bert_config_file=$BERT_BASE_DIR/bert_config.json   --init_checkpoint=$BERT_BASE_DIR/bert_model.ckpt   --save_checkpoints_steps=500   --train_batch_size=32   --max_seq_length=128   --max_predictions_per_seq=20   --num_train_steps=2500   --num_warmup_steps=250 --learning_rate=5e-5
wait
