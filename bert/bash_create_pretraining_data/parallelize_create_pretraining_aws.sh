...
foo () {
   ...
   # source activate tensorflow_p27
    ...
    python create_pretraining_data.py   --input_file=./data/part-000000000$run.txt   --output_file=./data/tfrecords_seq_length128/tfrecord_128_part-000000000$run.tfrecord   --vocab_file=$BERT_BASE_DIR/vocab.txt   --do_lower_case=False   --max_seq_length=128   --max_predictions_per_seq=20   --masked_lm_prob=0.15   --random_seed=12345 --dupe_factor=5
